...
import { AnswerPayload, answerPayloadFromAttempt, isAnswerPayloadAttempted, normalizeQuestions } from '@/lib/questionNormalization';
  ...
  const handleSubmit = async (data: NTASubmitData) => {
    try {
      ...
      setTestReportState(String(attemptId), {
        ...
        returnTo: '/(auth)/test/custom-create',
        returnLabel: 'Back to Custom Tests',
      });
      router.replace({
